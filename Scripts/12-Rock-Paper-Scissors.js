...
document.body.addEventListener('keydown',(event) => {
  if (event.key === 'r') {//same as "onclick=Play_game('Rock');" for r
    Play_game('Rock');
  }else if (event.key === 'p') {//same as "onclick=Play_game('Paper');" for p
    Play_game('Paper');
  }else if (event.key === 's') {//same as "onclick=Play_game('Scissors');" for s
    Play_game('Scissors');
  }else {
